...
def build_or_load_gen_model(args):
    ...
    if args.model_type == 'roberta':
        ...
        #model = model_class.from_pretrained(args.model_name_or_path, dropout_rate=args.dropout_rate)
    ...
    if args.load_model_path is not None:
        ...
        map_location = {"cuda:%d" % 0: "cuda:%d" % args.rank} if args.distributed else None
    ...
    def forward(self, source_ids=None, source_mask=None, target_ids=None, target_mask=None, args=None):
        ...
        if target_ids is not None:
            ...
            for i in range(source_ids.shape[0]):
                ...
                sample_scores = [s[0].exp().cpu().item() for s in beam.finished]
...
class UniXCoderSeq2Seq(nn.Module):
    ...
    """
    def __init__(self, encoder,decoder, config, beam_size=None, max_length=None, sos_id=None, eos_id=None):
        super(UniXCoderSeq2Seq, self).__init__()
        self.encoder = encoder
        self.decoder=decoder
        self.config=config
